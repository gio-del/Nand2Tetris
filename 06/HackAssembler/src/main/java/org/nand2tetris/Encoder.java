...
public class Encoder {
    ...
    public static String dest(String instructionDest) {
        return destMap.get(instructionDest);
    }

    public static String comp(String instructionComp) {
        return compMap.get(instructionComp);
    }

    public static String jump(String instructionJump) {
        return jumpMap.get(instructionJump);
    }
}
